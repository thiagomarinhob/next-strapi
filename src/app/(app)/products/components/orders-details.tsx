...
export function OrdersDetails({ product }: any) {
  return (
    <DialogTrigger>
      <DialogHeader>
        <DialogTitle>Pedido: 1231kjbkjbkj</DialogTitle>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-right">R$ 89,99</TableCell>
            </TableRow>
